                    ...
                    return InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Container(
                            ...
                            child: Text(kundliController.reportTab[index].title, style: TextStyle(fontSize: 13))),
                      ),
                    );
                  });
                });
            ...
            child: Container(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Description', style: Get.textTheme.titleMedium!.copyWith(fontWeight: FontWeight.bold)).tr(),
                    const SizedBox(
                      height: 10,
                    ),
                    Text('${kundliController.generalDesc}', style: Get.textTheme.titleMedium!.copyWith(fontSize: 14))
                  ],
                ),
              ),
            ),
