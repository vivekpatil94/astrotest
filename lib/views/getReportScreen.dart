                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '${tr("Experience")}: ${bottomNavigationController.astrologerList[index].experienceInYears} ${tr("Years")}',
                                            style: Get.theme.primaryTextTheme
                                                .bodySmall!
                                                .copyWith(
                                              fontWeight: FontWeight.w300,
                              ...
                              Row(
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child: minBalance != ''
                                        ? Text('${tr("Minimum balance")} ${global.getSystemFlagValueForLogin(global.systemFlagNameList.currency)} $minBalance is required to get report from $astrologer ',
                                                style: TextStyle(
                                                    fontWeight: FontWeight.w500,
                                                    color: Colors.red))
                                            .tr()
