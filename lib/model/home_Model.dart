...
class TopOrder {
  TopOrder({this.id, this.userId, this.astrologerId, this.orderType, this.productCategoryId, this.productId, this.orderAddressId, this.payableAmount, this.walletBalanceDeducted, this.gstPercent, this.totalPayable, this.couponCode, this.paymentMethod, this.orderStatus, this.totalMin, this.createdAt, this.updatedAt, this.astrologerName, this.profileImage, this.chatId, this.callId, this.firebaseChatId,this.duration,this.call_type});
