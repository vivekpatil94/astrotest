...
SouthKundaliMatchingModel southKundaliMatchingModelFromJson(String str) => SouthKundaliMatchingModel.fromJson(json.decode(str));

String southKundaliMatchingModelToJson(SouthKundaliMatchingModel data) => json.encode(data.toJson());
...
class SouthKundaliMatchingModel {
  ...
  factory SouthKundaliMatchingModel.fromJson(Map<String, dynamic> json) => SouthKundaliMatchingModel(
...
class RecordListResponse {
  ...
  factory RecordListResponse.fromJson(Map<String, dynamic> json) => RecordListResponse(
    ...
    mahendra: json["mahendra"] == null ? null : Dina.fromJson(json["mahendra"]),
    ...
    rasiathi: json["rasiathi"] == null ? null : Rasiathi.fromJson(json["rasiathi"]),
