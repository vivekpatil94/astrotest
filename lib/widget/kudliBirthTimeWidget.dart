    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text('Note:Without time of birth,we can still achive upto 80% accurate predictions', style: Get.textTheme.titleMedium!.copyWith(fontSize: 12, color: Colors.grey)).tr(),
        ),
        SizedBox(
          height: 20,
        ),
