...
class CallController extends GetxController with GetSingleTickerProviderStateMixin {
  ...
  showBottomAcceptCallRequest({required int astrologerId, required String channelName, required int callId, required String astroName, required String fcmToken, required String astroProfile, required String token,required String callType,required int duration}) async {
